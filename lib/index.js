...
exports.setFallbackLocale = exports.setLocale = exports.registerTranslations = exports.translate = exports.counterpart = undefined;
...
function _setLocaleIntern(value) {
  ...
  if (previous != value) {
    ...
    _events2.default.EventEmitter.emit('localechange', value, previous);
  }
...
function _translateIntern(key, options) {
  ...
  if (entry === null && options.fallback) {
    _events2.default.EventEmitter.emit('translationnotfound', locale, key, options.fallback, scope);
